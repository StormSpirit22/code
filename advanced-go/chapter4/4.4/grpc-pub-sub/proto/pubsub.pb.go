...
var file_pubsub_proto_rawDesc = []byte{
	,
...
var file_pubsub_proto_goTypes = []interface{}{
	(*String)(nil), // 0: template.String
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: template.PubsubService.Publish:input_type -> template.String
	0, // 1: template.PubsubService.Subscribe:input_type -> template.String
	0, // 2: template.PubsubService.Publish:output_type -> template.String
	0, // 3: template.PubsubService.Subscribe:output_type -> template.String
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/template.PubsubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[0], "/template.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.PubsubService/Publish",
	}
...
var _PubsubService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "template.PubsubService",
